...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- Contact Page (kontak/contactPage.html) specific form handler is now in js/contactPage.js ---
    ...
    const analysisInputContainer = document.getElementById('analysis-input-container');
    ...
    if (tabFile && tabUrl && tabSearch && analysisInputContainer) {
        updateActiveTab(tabUrl); // Default to URL tab
    ...
    if (analysisForm) {
        analysisForm.addEventListener('submit', function (event) {
            event.preventDefault();
            const currentUrlInput = document.getElementById('url-input');
